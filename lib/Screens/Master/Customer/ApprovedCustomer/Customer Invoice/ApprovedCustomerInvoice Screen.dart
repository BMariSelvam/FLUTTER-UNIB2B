...
import 'ApprovedCustomerInvoice Screen Controller.dart';

class ApprovedCustomerInvoiceScreen extends StatefulWidget {
  const ApprovedCustomerInvoiceScreen({super.key});

  @override
  State<ApprovedCustomerInvoiceScreen> createState() => _ApprovedCustomerInvoiceScreenState();
}

class _ApprovedCustomerInvoiceScreenState extends State<ApprovedCustomerInvoiceScreen> {
  DateTime? fromDate;
  DateTime? toDate;
  bool isSearching=false;
  String selectedFilter = "";
  List<QuatationDetailList> originalProductList = [];
  late ApprovedCustomerInvoiceController controller;
  @override
  void initState(){
    super.initState();
    controller=Get.put(ApprovedCustomerInvoiceController());
