...
import 'package:universal_b2b/Screens/Purchase/Purchase%20Quatation/Quatation%20ListScreen%20Controller.dart';
import 'package:universal_b2b/Widget/DropdownButton.dart';
...
class QuatationListPage extends StatefulWidget {
  const QuatationListPage({Key? key}) : super(key: key);

  @override
  State<QuatationListPage> createState() => _QuatationListPageState();
}

class _QuatationListPageState extends State<QuatationListPage> {
  DateTime? fromDate;
  DateTime? toDate;
  List<QuatationDetailList> originalProductList = [];
  String selectedFilter = "";
  bool isSearching=false;
  late QuatationListController controller;
  ...
  void initState(){
    //TODO:implement
    super.initState();
    controller=Get.put(QuatationListController());
