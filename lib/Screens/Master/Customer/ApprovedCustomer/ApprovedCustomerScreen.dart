...
class ApprovedCustomerScreen extends StatefulWidget {
  const ApprovedCustomerScreen({super.key});

  @override
  State<ApprovedCustomerScreen> createState() => _ApprovedCustomerScreenState();
}

class _ApprovedCustomerScreenState extends State<ApprovedCustomerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(style: const ButtonStyle(tapTargetSize: MaterialTapTargetSize.shrinkWrap),
              onPressed: () {}, icon: const Icon(Icons.calendar_today_outlined, color: MyColors.white,)),
          IconButton(
              onPressed: () {}, icon: Icon(Icons.delete,color: MyColors.white)),
        ],
      ),
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                      ...
                      shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(5))),
                  child: Text("Yes", style: TextStyle(color: MyColors.white)),
                ),
              ],
            ),
          ],
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    "Connected Request Send Successfully",
                    style: TextStyle(
                      fontFamily: MyFont.myFont,
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: buildIconButton(
              onPressed: () {
                Get.toNamed(Routes.approvedCustomerInvoiceScreen);
          ...
          Expanded(
            child: buildIconButton(
              onPressed: () {
                 Get.toNamed(Routes.approvedCustomerFrequentorderScreen);
              },
              icon: Assets.cfo,
              label: 'Frequent Orders',
            ),
          ),
          Expanded(
            child: buildIconButton(
