...
import 'package:universal_b2b/Screens/Products/Category%20Screen/Category_list_Controller.dart';
...
class _CategoryListScreenState extends State<CategoryListScreen> {
  List<CategoryDetailList> originalProductList = [];
  String selectedFilter = "";
  bool isSearching=false;
  late CategoryListControll controller;
  ...
  void initState(){
    ...
    originalProductList = List.from(CategoryListContent);
    super.initState();
    controller=Get.put(CategoryListControll());
  }
  @override
                          ...
                          child: SizedBox(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  CategoryListContent[index].code,
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                  style: TextStyle(
                                    fontFamily: MyFont.myFont,
  ...
  List<CategoryDetailList> CategoryListContent = [
    CategoryDetailList(
        name: 'Pushparaj',
        code: 'Code #625335',
    ...
    CategoryDetailList(
        name: 'Pushparaj',
        code: 'Code #625342',
        image: Assets.productBanner),CategoryDetailList(
        name: 'Pushparaj',
        code: 'Code #625343',
        image: Assets.productBanner),CategoryDetailList(
        name: 'Pushparaj',
  ...
  void handleFilterSelection(String value) {
    ...
    switch (value) {
      case "A-Z":
        CategoryListContent.sort((a, b) => a.name.compareTo(b.name));
        break;
      case "Z-A":
        CategoryListContent.sort((a, b) => b.name.compareTo(a.name));
        break;
      default:
        break;
    }
  ...
  void handleSearch() {
    ...
    if (searchTerm.isEmpty) {
      ...
      setState(() {
        CategoryListContent = originalProductList;
      });
    } else {
      // If there is a search term, filter the product list
      List<CategoryDetailList> filteredList = originalProductList
          .where((product) =>
      ...
      setState(() {
        CategoryListContent = filteredList;
      });
    }
  }
}
