...
import 'package:universal_b2b/Screens/Purchase/Purchase%20Return/Purchase%20Returnscreen%20Controller.dart';

import '../../../Const/approute.dart';
import '../../../Const/color.dart';
import '../../../Const/font.dart';
import '../../../Widget/Constructors/constructors.dart';
import '../../../Widget/popupmenu button.dart';
...
class _PurchaseReturnScreenState extends State<PurchaseReturnScreen> {
  ...
  List<PurchaseReturnDetailList> originalProductList = [];
  Offset _tapPosition = Offset.zero;
  late PurchaseReturnListController controller;
  ...
  void initState(){
    super.initState();
    controller=Get.put(PurchaseReturnListController());
    originalProductList = List.from(PurchaseReturnListContent);
  }
  void showFilterMenu() {
    showMenu(
      context: context,
  ...
  void handleSearch() {
    ...
    if (searchTerm.isEmpty) {
      ...
      setState(() {
        PurchaseReturnListContent = originalProductList;
      });
    } else {
      // If there is a search term, filter the product list
      List<PurchaseReturnDetailList> filteredList = originalProductList
          .where((product) =>
      product.name.toLowerCase().contains(searchTerm) ||
          product.price.toLowerCase().contains(searchTerm))
          .toList();

      setState(() {
        PurchaseReturnListContent = filteredList;
      });
    }
  }
