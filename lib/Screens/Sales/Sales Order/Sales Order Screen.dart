...
import 'package:universal_b2b/Screens/Sales/Sales%20Order/Sales%20OrderScreen%20Controller.dart';
...
class _SalesOrderScreenState extends State<SalesOrderScreen> {
  ...
  late SalesOrderListController controller;
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            IconButton(
                onPressed: () {
                  Get.toNamed(Routes.addsalesorderscreen);
                },
                icon: const Icon(
  ...
  List<QuatationDetailList> QuatationListContent = [
    QuatationDetailList(
        name: 'Pushparaj',
        code: 'Sales.No #625335',
        date: 'May 21,2019,3.30pm'),
    QuatationDetailList(
        name: 'Pushparaj',
        code: 'Sales.No #625336',
        date: 'May 21,2019,3.30pm'),
    QuatationDetailList(
        name: 'Pushparaj',
        code: 'Sales.No #625337',
        date: 'May 21,2019,3.30pm'),
    QuatationDetailList(
        name: 'Pushparaj',
        code: 'Sales.No #625338',
        date: 'May 21,2019,3.30pm'),
    QuatationDetailList(
        name: 'Pushparaj',
        code: 'Sales.No #625339',
        date: 'May 21,2019,3.30pm'),
    QuatationDetailList(
        name: 'Pushparaj',
        code: 'Sales.No #625340',
        date: 'May 21,2019,3.30pm'),
    QuatationDetailList(
        name: 'Pushparaj',
        code: 'Sales.No #625341',
        date: 'May 21,2019,3.30pm'),
    QuatationDetailList(
        name: 'Pushparaj',
        code: 'Sales.No #625342',
        date: 'May 21,2019,3.30pm'),
    QuatationDetailList(
        name: 'Pushparaj',
        code: 'Sales.No #625343',
        date: 'May 21,2019,3.30pm'),
    QuatationDetailList(
        name: 'Pushparaj',
        code: 'Sales.No #625344',
        date: 'May 21,2019,3.30pm'),
  ];
  void handleSearch() {
