...
import 'package:universal_b2b/Screens/Purchase/Purchase%20Quatation/Add_QuatationScreen_Controller.dart';
...
class AddQuatationScreen extends StatefulWidget {
  const AddQuatationScreen({Key? key}) : super(key: key);

  @override
  State<AddQuatationScreen> createState() => _AddQuatationScreenState();
}

class _AddQuatationScreenState extends State<AddQuatationScreen> {
  late AddQuatationScreenController controller;
  @override
  void initState(){
    super.initState();
    controller=Get.put(AddQuatationScreenController());
  }
  @override
