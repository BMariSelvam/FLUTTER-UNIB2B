...
import 'Add Sales QuatationScreen Controller.dart';

class AddSalesQuatationScreen extends StatefulWidget {
  const AddSalesQuatationScreen({Key? key}) : super(key: key);

  @override
  State<AddSalesQuatationScreen> createState() => _AddSalesQuatationScreenState();
}

class _AddSalesQuatationScreenState extends State<AddSalesQuatationScreen> {
  late AddSalesQuatationScreenController controller;
  @override
  void initState(){
    super.initState();
    controller=Get.put(AddSalesQuatationScreenController());
  }
  @override
