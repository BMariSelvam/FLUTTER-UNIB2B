...
class PurchaseAnalyticsScreen extends StatefulWidget {
  const PurchaseAnalyticsScreen({Key? key}) : super(key: key);

  @override
  State<PurchaseAnalyticsScreen> createState() => _PurchaseAnalyticsScreenState();
}

class _PurchaseAnalyticsScreenState extends State<PurchaseAnalyticsScreen> {
  @override
