...
import 'package:universal_b2b/Screens/Purchase/Purchase%20Order/Add%20Purchase%20Order%20Controller.dart';
...
class AddPurchaseOrderScreen extends StatefulWidget {
  const AddPurchaseOrderScreen({Key? key}) : super(key: key);
...
class _AddPurchaseOrderScreenState extends State<AddPurchaseOrderScreen> {
  late AddPurchaseOrderScreenController controller;

  @override
  void initState(){
    super.initState();
    controller=Get.put(AddPurchaseOrderScreenController());
  }
  @override
