...
import 'Tax Screen Controller.dart';
...
class _TaxScreenState extends State<TaxScreen> {
  List<CurrencyDetailList> originalProductList = [];
  String selectedFilter = "";
  bool isSearching=false;
  Offset _tapPosition = Offset.zero;
  late TaxListController controller;
  ...
  @override
  void initState(){
    originalProductList = List.from(currencyListContent);
    //TODO:implement iniState
    super.initState();
    controller=Get.put(TaxListController());
  }
  @override
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            IconButton(
                onPressed: () {
                  Get.toNamed(Routes.addtaxscreen);
                },
                icon: const Icon(
  ...
  productList() {
    return Padding(
      ...
      child: ListView.builder(
        ...
        itemCount: currencyListContent.length,
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Flexible(
                        child: SizedBox(
                          child: Column(
                            ...
                            children: [
                              Text(
                                currencyListContent[index].name,
                                maxLines: 1,
                              ...
                              Text(
                                currencyListContent[index].about,
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: TextStyle(
                                  fontFamily: MyFont.myFont,
                      ...
                      SizedBox(width:width(context)/9),
                      Flexible(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Row(
                              children: [
                                ...
                                Text(
                                  currencyListContent[index].rate,
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                  style: TextStyle(
                                    fontFamily: MyFont.myFont,
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  currencyListContent[index].value,
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                  style: TextStyle(
                                    fontFamily: MyFont.myFont,
  ...
  List<CurrencyDetailList> currencyListContent = [
    CurrencyDetailList(
        name: 'Pushparaj',
        about: 'T.Code#871',
        rate: 'AAAA',
  ...
  void handleFilterSelection(String value) {
    ...
    switch (value) {
      case "A-Z":
        currencyListContent.sort((a, b) => a.name.compareTo(b.name));
        break;
      case "Z-A":
        currencyListContent.sort((a, b) => b.name.compareTo(a.name));
        break;
      default:
        break;
    }
  ...
  void handleSearch() {
    ...
    if (searchTerm.isEmpty) {
      ...
      setState(() {
        currencyListContent = originalProductList;
      });
    } else {
      // If there is a search term, filter the product list
      List<CurrencyDetailList> filteredList = originalProductList
          .where((product) =>
      ...
      setState(() {
        currencyListContent = filteredList;
      });
    }
  }
}
