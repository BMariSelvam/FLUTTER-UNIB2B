...
import 'package:universal_b2b/Screens/Master/Customer/ApprovedCustomer/TotalOrders/TotalOrdersController.dart';
...
class _TotalOrdersScreenState extends State<TotalOrdersScreen> {
  ...
  late TotalOrdersController controller;
  DateTime? fromDate;
  DateTime? toDate;
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return GestureDetector(
          onTap: () {
            Get.toNamed(Routes.totalOrderDetailsScreen);
          },
          child: Padding(
