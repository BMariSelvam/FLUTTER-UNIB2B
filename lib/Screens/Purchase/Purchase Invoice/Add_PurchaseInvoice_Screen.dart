...
import 'package:universal_b2b/Screens/Purchase/Purchase%20Invoice/Add_PurchaseInvoice_Controller.dart';
...
class AddPurchaseInvoiceScreen extends StatefulWidget {
  const AddPurchaseInvoiceScreen({Key? key}) : super(key: key);
...
class _AddPurchaseInvoiceScreenState extends State<AddPurchaseInvoiceScreen> {
  ...
  late AddInvoiceScreenController controller;
  @override
  void initState(){
    super.initState();
    controller=Get.put(AddInvoiceScreenController());
  }
  @override
