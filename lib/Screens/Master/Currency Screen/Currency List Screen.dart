...
import 'Currency Listscreen Controller.dart';
...
class _CurrencyListScreenState extends State<CurrencyListScreen> {
  ...
  late CurrencyListController controller;
  ...
  void initState(){
    ...
    super.initState();
    controller=Get.put(CurrencyListController());
  }
  @override
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            IconButton(
                onPressed: () {
                  Get.toNamed(Routes.addcurrencyscreen);
                },
                icon: const Icon(
