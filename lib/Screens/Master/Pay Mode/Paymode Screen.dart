...
import '../../Products/Brand Screen/Brand List Controller.dart';
import 'Paymode Screen Controller.dart';

class PayModeScreen extends StatefulWidget {
  const PayModeScreen({Key? key}) : super(key: key);
...
class _PayModeScreenState extends State<PayModeScreen> {
  ...
  late PayModeListController controller;
  ...
  void initState(){
    ...
    super.initState();
    controller=Get.put(PayModeListController());
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            IconButton(
                onPressed: () {
                  Get.toNamed(Routes.addpaymodescreen);
                },
                icon: const Icon(
